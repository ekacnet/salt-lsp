...
from salt_lsp.types import (AstMapNode, AstNode, IncludeNode, IncludesNode,
                            NullUndefined, Position, RequisiteNode,
                            RequisitesNode, StateCallNode, StateNode,
                            StateParameterNode, TokenNode, Tree)
...
class Parser:
    ...
    def _is_last_breadcrumb(self: Parser, classType: Union[type, Tuple[type]]) -> bool:
